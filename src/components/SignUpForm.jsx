...
const SignUpForm = () => {
    ...
    const handleSignup = async(e) => {
        try {
            e.preventDefault();
            setLoading(true);
            const res = await axios.post('https://student-job-tracker-backend-production-a06d.up.railway.app/auth/signup', {name, email, password, gender, age}, {withCredentials: true})
